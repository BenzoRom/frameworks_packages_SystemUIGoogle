...
public interface ColumbusModule {
    ...
    static SettingsAction provideSettingsActionColumbus(
            ...
            UiEventLogger uiEventLogger) {
        return new SettingsAction(context, centralSurfaces, uiEventLogger);
    }
    ...
    static ToggleFlashlight provideToggleFlashlight(
            Context context,
            Set<FeedbackEffect> feedbackEffect,
            FlashlightController flashlightController,
            Handler handler,
            UiEventLogger uiEventLogger) {
        return new ToggleFlashlight(
                context,
                feedbackEffect,
    ...
    static OpenNotificationShade provideOpenNotificationShade(
            ...
            Lazy<CentralSurfaces> centralSurfaces,
            UiEventLogger uiEventLogger) {
    ...
    static Set<Action> provideSetupWizardActions(SettingsAction settingsAction) {
        return new HashSet<>(Collections.singletonList(settingsAction));
    }
}
